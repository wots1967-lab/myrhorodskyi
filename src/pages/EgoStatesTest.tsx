...
const EgoStatesTest = () => {
  usePageSEO({
    title: 'Тест: Профіль Его-станів — Транзакційний аналіз онлайн',
    description: 'Пройдіть тест функціональних Его-станів за методикою Джулі Хей. Дізнайтеся свій профіль: Контролюючий Батько, Опікаючий Батько, Дорослий, Вільна Дитина, Адаптована Дитина.',
    canonical: 'https://myrhorodskyi.lovable.app/tests/profil-ego-staniv',
    keywords: 'его стани, транзакційний аналіз, тест его-станів, егограма, психологічний тест',
  });
