...
const Tests = () => {
  usePageSEO({
    ...
    description: 'Безкоштовні психологічні тести українською. Тести на тривогу, депресію, вигорання, самооцінку та емоційний інтелект. Пройди тест і дізнайся більше про себе.',
    canonical: 'https://myrhorodskyi.com/tests',
    keywords: 'психологічні тести онлайн, тест на тривогу, тест на депресію, тест на вигорання, тест самооцінки, психологічний тест українською',
  });
