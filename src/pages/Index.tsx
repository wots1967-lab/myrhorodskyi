...
const Index = () => {
  usePageSEO({
    ...
    description: 'Психолог Сергій Миргородський — індивідуальні консультації, психотерапія, КПТ, схема-терапія, IFS. Тривога, вигорання, стосунки, кризи ідентичності. Онлайн, українською.',
