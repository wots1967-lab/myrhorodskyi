...
const topics = [
  ...
  'Міграція, переїзд',
  'Пережити зраду',
  'Досягти змін у житті',
  'Впоратись з розставанням',
  'Відновити здатність радіти',
  'Підвищити лібідо',
  'Підвищити самооцінку',
  'Баланс між життям і роботою',
  'Вийти з аб\'юзивних стосунків',
  ...
  'Прибрати фінансові блоки',
  'Покращити сексуальне життя',
  'Усвідомити свої бажання',
  'Налагодити бізнес стосунки',
  'Знайти нові сенси',
  'Позбутися безсоння',
          ...
          {topics.map((topic, index) => {
            ...
            return (
              <motion.button
                ...
                className={`px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer select-none border ${
                  isSelected
                    ? 'bg-secondary text-secondary-foreground border-secondary shadow-md scale-105'
                    : 'bg-card/80 text-foreground border-border hover:bg-secondary/15 hover:border-secondary/50 hover:shadow-sm'
                }`}
