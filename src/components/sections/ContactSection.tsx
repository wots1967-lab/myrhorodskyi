  ...
  return (
    <section id="contact" className="section-padding relative z-10">
      <div className="container-custom glass-card rounded-3xl p-8 md:p-12">
        <div ref={ref} className={`reveal${revealed ? ' revealed' : ''} text-center max-w-2xl mx-auto`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://t.me/sigurdpsy" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/sigurd.psy/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-3 p-4 bg-muted rounded-xl hover:bg-muted/70 transition-colors">
